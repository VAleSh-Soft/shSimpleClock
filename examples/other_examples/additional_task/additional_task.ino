 ...
 *        используется опция ADDITIONAL_TASKS_COUNT в разделе "прочие настройки"
 *        файла clockSetting.h.
 * 
...
// callback-функция, которая будет вызываться при срабатывании задачи
void addedTask()
{
