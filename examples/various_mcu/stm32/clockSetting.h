...
#define DISPLAY_CLK_PIN PB8 // пин для подключения экрана - CLK
#define DISPLAY_DAT_PIN PB9 // пин для подключения экрана - DAT
...
#define LCD_SCL_PIN PB6 // пин для подключения вывода SCL экрана (не менять!!!)
...
#define DISPLAY_CLK_PIN PA5 // пин для подключения экрана - CLK (не менять!!!)
#define DISPLAY_DIN_PIN PA7 // пин для подключения экрана - DAT (не менять!!!)
#define DISPLAY_CS_PIN PA4  // пин для подключения экрана - CS
...
#define DISPLAY_DIN_PIN PC13 // пин для подключения экрана - DIN
...
*/
#define BTN_SET_PIN PA3  // пин для подключения кнопки Set
#define BTN_DOWN_PIN PA2 // пин для подключения кнопки Down
#define BTN_UP_PIN PA1   // пин для подключения кнопки Up
...
#define ALARM_LED_PIN PB14 // пин для подключения светодиода - индикатора будильника
...
// ==== пищалка ======================================
#define BUZZER_PIN PB15 // пин для подключения пищалки
...
// ---- модуль RTC - пины -----------------------
#define RTC_SDA_PIN PB7 // пин для подключения вывода SDA RTC модуля (не менять!!!)
#define RTC_SCL_PIN PB6 // пин для подключения вывода SCL RTC модуля (не менять!!!)
