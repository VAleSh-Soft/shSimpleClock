...
int8_t constexpr DISPLAY_CLK_PIN = PB8; // пин для подключения экрана - CLK
int8_t constexpr DISPLAY_DAT_PIN = PB9; // пин для подключения экрана - DAT
...
int8_t constexpr DISPLAY_CLK_PIN = PA5; // пин для подключения экрана - CLK (не менять!!!)
int8_t constexpr DISPLAY_DIN_PIN = PA7; // пин для подключения экрана - DAT (не менять!!!)
int8_t constexpr DISPLAY_CS_PIN = PA4;  // пин для подключения экрана - CS
...
int8_t constexpr DISPLAY_DIN_PIN = PC13; // пин для подключения экрана - DIN
...
int8_t constexpr ALARM_LED_PIN = PB14; // пин для подключения светодиода - индикатора будильника
...
// ==== пищалка ======================================
int8_t constexpr BUZZER_PIN = PB15; // пин для подключения пищалки
...
int8_t constexpr LIGHT_SENSOR_PIN = PB1; 
...
// ---- DS18B20 - пин ----------------------
int8_t constexpr DS18B20_PIN = PB12; 
