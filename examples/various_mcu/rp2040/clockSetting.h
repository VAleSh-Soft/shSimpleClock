...
#define DISPLAY_CLK_PIN 29 // пин для подключения экрана - CLK
#define DISPLAY_DAT_PIN 28 // пин для подключения экрана - DAT
...
#define DISPLAY_CLK_PIN 2 // пин для подключения экрана - CLK
#define DISPLAY_DIN_PIN 3 // пин для подключения экрана - DAT
#define DISPLAY_CS_PIN 5  // пин для подключения экрана - CS
...
#define DISPLAY_DIN_PIN 2  // пин для подключения экрана - DIN
...
*/
#define BTN_SET_PIN 15  // пин для подключения кнопки Set
#define BTN_DOWN_PIN 14 // пин для подключения кнопки Down
#define BTN_UP_PIN 13   // пин для подключения кнопки Up
...
#define ALARM_LED_PIN 11 // пин для подключения светодиода - индикатора будильника
...
// ==== пищалка ======================================
#define BUZZER_PIN 12    // пин для подключения пищалки
