...
#define LCD_SDA_PIN 12 // пин для подключения вывода SDA экрана
#define LCD_SCL_PIN 13 // пин для подключения вывода SCL экрана
...
int8_t constexpr DISPLAY_CLK_PIN = 2; // пин для подключения экрана - CLK
int8_t constexpr DISPLAY_DIN_PIN = 3; // пин для подключения экрана - DAT
