...
#define LCD_SDA_PIN D2 // пин для подключения вывода SDA экрана (не менять!!!)
#define LCD_SCL_PIN D1 // пин для подключения вывода SCL экрана (не менять!!!)
...
// ---- модуль RTC - пины -----------------------
#define RTC_SDA_PIN D2 // пин для подключения вывода SDA RTC модуля (не менять!!!)
