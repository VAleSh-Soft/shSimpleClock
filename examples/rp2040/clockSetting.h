...
int8_t constexpr DISPLAY_CLK_PIN = 29; // пин для подключения экрана - CLK
int8_t constexpr DISPLAY_DAT_PIN = 28; // пин для подключения экрана - DAT
...
#define LCD_SDA_PIN 12 // пин для подключения вывода SDA экрана (не менять!!!)
#define LCD_SCL_PIN 13 // пин для подключения вывода SCL экрана (не менять!!!)
...
int8_t constexpr DISPLAY_CLK_PIN = 2; // пин для подключения экрана - CLK (не менять!!!)
int8_t constexpr DISPLAY_DIN_PIN = 3; // пин для подключения экрана - DAT (не менять!!!)
int8_t constexpr DISPLAY_CS_PIN = 5;  // пин для подключения экрана - CS
...
int8_t constexpr DISPLAY_DIN_PIN = 2; // пин для подключения экрана - DIN
...
*/
int8_t constexpr BTN_SET_PIN = 15;  // пин для подключения кнопки Set
int8_t constexpr BTN_DOWN_PIN = 14; // пин для подключения кнопки Down
int8_t constexpr BTN_UP_PIN = 13;   // пин для подключения кнопки Up
...
int8_t constexpr ALARM_LED_PIN = 11; // пин для подключения светодиода - индикатора будильника
...
// ==== пищалка ======================================
int8_t constexpr BUZZER_PIN = 12;    // пин для подключения пищалки
...
int8_t constexpr LIGHT_SENSOR_PIN = 27; 
...
// ---- DS18B20 - пин ----------------------
int8_t constexpr DS18B20_PIN = 9; 
...
// ---- модуль RTC - пины -----------------------
#define RTC_SDA_PIN 12 // пин для подключения вывода SDA RTC модуля (не менять!!!)
#define RTC_SCL_PIN 13 // пин для подключения вывода SCL RTC модуля (не менять!!!)
