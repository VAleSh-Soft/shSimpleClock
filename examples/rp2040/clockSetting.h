...
#define LCD_SDA_PIN 0 // пин для подключения вывода SDA экрана (не менять!!!)
#define LCD_SCL_PIN 1 // пин для подключения вывода SCL экрана (не менять!!!)
...
// ---- модуль RTC - пины -----------------------
#define RTC_SDA_PIN 0 // пин для подключения вывода SDA RTC модуля (не менять!!!)
#define RTC_SCL_PIN 1 // пин для подключения вывода SCL RTC модуля (не менять!!!)
