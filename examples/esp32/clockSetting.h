 ...
 *   LCD_1602_I2C_DISPLAY     - двухстрочный LCD экран по 16 символов на строку,
 *                              подключаемый по I2C
 */
...
int8_t constexpr DISPLAY_CLK_PIN = 32; // пин для подключения экрана - CLK
int8_t constexpr DISPLAY_DAT_PIN = 33; // пин для подключения экрана - DAT
...
#define LCD_SDA_PIN 21 // пин для подключения вывода SDA экрана (не менять!!!)
#define LCD_SCL_PIN 22 // пин для подключения вывода SCL экрана (не менять!!!)
...
int8_t constexpr DISPLAY_CLK_PIN = 18; // пин для подключения экрана - CLK (не менять!!!)
int8_t constexpr DISPLAY_DIN_PIN = 23; // пин для подключения экрана - DAT (не менять!!!)
int8_t constexpr DISPLAY_CS_PIN = 4;  // пин для подключения экрана - CS
...
int8_t constexpr DISPLAY_DIN_PIN = 4; // пин для подключения экрана - DIN
...
*/
int8_t constexpr BTN_SET_PIN = 25;  // пин для подключения кнопки Set
int8_t constexpr BTN_DOWN_PIN = 26; // пин для подключения кнопки Down
int8_t constexpr BTN_UP_PIN = 27;   // пин для подключения кнопки Up
...
int8_t constexpr ALARM_LED_PIN = 14; // пин для подключения светодиода - индикатора будильника
...
// ==== пищалка ======================================
int8_t constexpr BUZZER_PIN = 16;    // пин для подключения пищалки
...
int8_t constexpr LIGHT_SENSOR_PIN = 34; 
...
// ---- DS18B20 - пин ----------------------
int8_t constexpr DS18B20_PIN = 17; 
...
#define BIT_DEPTH 10 // разрядность АЦП используемого микроконтроллера; для Ардуино UNO, Nano, Pro Mini BIT_DEPTH = 10
...
// ---- модуль RTC - пины -----------------------
#define RTC_SDA_PIN 21 // пин для подключения вывода SDA RTC модуля (не менять!!!)
#define RTC_SCL_PIN 22 // пин для подключения вывода SCL RTC модуля (не менять!!!)
