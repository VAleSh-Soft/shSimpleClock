...
```
задают настройки кнопок - интервал удержания кнопки нажатой, интервал выдачи событий **BTN_LONGCLICK** при удержании кнопки нажатой (используется для кнопок **Up** и **Down**) и интервал антидребезга соответственно. Все настройки задаются в милисекундах.
