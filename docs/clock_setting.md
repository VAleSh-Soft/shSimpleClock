...
Для экрана **LCD 1602** нужно указать адрес устройства на шине **I2C**; адрес задается в строке 
```
...
***Режим регулировки уровня яркости не доступен для LCD 1602 экранов***
