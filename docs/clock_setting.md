...
Номера пинов соответствуют номерам пинов аппаратного **I2C** выбранного МК, к которым подключен модуль **RTC** и приведены только для информации;
...
Модули работают через аппаратный **I2C** микроконтроллера, соответственно, пины аппаратного **I2C** выбранного МК их и нужно указывать.
