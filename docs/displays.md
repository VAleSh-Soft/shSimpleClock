...
Экран должен подлючаться к пинам того же аппаратного **I2C** вашего МК, что и модуль **RTC**, поэтому номера пинов указаны только для информации, в коде они нигде не используются.
