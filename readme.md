...
Версия 1.9 - 13.05.2026
 + добавлена поддержка двух дополнительных кнопок; обработка их событий лежит на пользователе ([см.](docs/buttons.md#взаимодействие-с-внешним-кодом));
 + добавлен пример работы с дополнительной кнопкой;
 + добавлены методы для настройки параметров дополнительных кнопок ([см.](docs/buttons.md#дополнительные-кнопки---настройка-параметров-отличных-от-настроек-основных-кнопок));
