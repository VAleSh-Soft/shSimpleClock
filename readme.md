...
Версия 1.6 - 17.05.2024
 ...
 + в файле **clockSetting.h** в блоке **настройки экранов** - **LCD_1602_I2C** добавлен рад параметров для настройки экрана - количество строк и символов, строки для вывода времени и т.д.;
