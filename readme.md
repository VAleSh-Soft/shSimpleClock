...
- Есть серьезные проблемы при использовании **STM32**:
  ...
  - при использовании аддона от **Roger Clark** библиотека работает только после замены нескольких файлов на доработанныe;

#### STM32

Работа библиотеки не тестировалась на **BlackPill** (**STM32F401CCU6** и **STM32F411CEU6**) с аддоном **Arduino_STM32 by Roger Clark**; как минимум в нем не реализована работа с **EEPROM**; разбираться с этим вопросом пока лень :) ;
