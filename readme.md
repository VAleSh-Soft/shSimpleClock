...
Версия 1.9 - 13.05.2026
 + добавлена поддержка двух дополнительных кнопок; обработка их событий лежит на пользователе;
 + добавлен пример работы с дополнительной кнопкой;
 + добавлены методы для настройки параметров дополнительных кнопок ([см.](docs/buttons.md));
